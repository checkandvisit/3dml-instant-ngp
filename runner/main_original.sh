...
sed -i "s/.\/data\/ours\/${scene}\/images/images/g" data/ours/${scene}/transform.json

python3 scripts/run.py --scene data/ours/${scene}/transform.json            \
        --mode nerf                                                         \
        --network base.json                                                 \
        --n_steps 2000                                                      \
        --screenshot_dir data/ours/${scene}/screenshot/                     \
        --screenshot_transforms data/ours/${scene}/transform.json           \
        --save_snapshot data/ours/${scene}/weight.msgpack
